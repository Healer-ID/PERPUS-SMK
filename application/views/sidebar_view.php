...
<aside class="main-sidebar">
	...
	<section class="sidebar">
        ...
        <?php if ($this->uri->uri_string() == 'user/edit/' . $this->uri->segment('3')) {
				...
				<li class="treeview 
					<?php if ($this->uri->uri_string() == 'peminjaman') {
						echo 'active';
					} ?>
					<?php if ($this->uri->uri_string() == 'peminjaman/pinjam') {
						echo 'active';
					} ?>
					<?php if ($this->uri->uri_string() == 'peminjaman/detailpinjam/' . $this->uri->segment('3')) {
						echo 'active';
					} ?>
					<?php if ($this->uri->uri_string() == 'peminjaman/kembalipinjam/' . $this->uri->segment('3')) {
						echo 'active';
					} ?>">
					<a href="#">
					...
					<ul class="treeview-menu">
						<li class="<?php if ($this->uri->uri_string() == 'peminjaman') {
										echo 'active';
									} ?>
							<?php if ($this->uri->uri_string() == 'peminjaman/pinjam') {
								echo 'active';
							...
							<a href="<?php echo base_url("Laporanbuku"); ?>" class="cursor">
								<span class="fa fa-upload"></span> Report Buku
							</a>
						</li>
